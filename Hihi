...
ImageButton.Image = "http://www.roblox.com/asset/?id=104681418484361"
...
local Window = Fluent:CreateWindow({
    Title = "Pkiet Roblox Tổng Hợp",
    SubTitle = "Blox Fruit và các game khác",
    TabWidth = 157,
...
local Tabs = {
    ...
    Callback = function()
        setclipboard("https://discord.gg/wsyDqnWM93")
    end
})

    Tabs.Main0:AddButton({
    Title = "ko có j",
    Description = "Pkiet Roblox",
    Callback = function()
